...
export class createTables1673984788715 implements MigrationInterface {
    name = 'createTables1673984788715'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying(120) NOT NULL, "description" character varying(300) NOT NULL, "price" numeric(12,2) NOT NULL, "amount" integer NOT NULL, "available" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_4c9fb58de893725258746385e16" UNIQUE ("name"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
